...
const FRED_MAPPINGS: FredMapping[] = [
  ...
  // gdp_investment/gdp_government/gdp_net_exports: contribución al % de
  // cambio del PIB real (NIPA tabla 1.1.2, BEA) — ya viene en puntos
  // porcentuales, no hace falta derivar de un índice. gdp_consumption es la
  // EXCEPCIÓN (a pedido del usuario, 26-ago-2026): antes era también una
  // contribución en pp (DPCERY2Q224SBEA), pero no coincidía con el "Real
  // Consumer Spending" que reporta investing.com — se reemplazó por la tasa
  // de crecimiento real del consumo en sí (NIPA tabla 1.1.1,
  // DPCERL1Q225SBEA). Ver comentario junto a gdp_consumption en indicators.ts.
  { indicatorId: 'gdp_consumption', seriesId: 'DPCERL1Q225SBEA', transform: 'level_pct' },
