...
export const FRED_MAPPINGS: FredMapping[] = [
  ...
  // Antes DPCERY2Q224SBEA (contribución al PIB en pp) — reemplazado a pedido
  // del usuario (26-ago-2026) por la tasa de crecimiento real del consumo en
  // sí (NIPA tabla 1.1.1), que es lo que investing.com muestra como "Real
  // Consumer Spending". Ver comentario en indicators.ts junto a gdp_consumption.
