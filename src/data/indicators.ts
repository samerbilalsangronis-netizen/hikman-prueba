...
const USD_INDICATORS: IndicatorMeta[] = [
  ...
  // Demanda interna/externa: subcomponentes del PIB (a pedido del usuario,
  // mismo patrón que los subcomponentes de ISM) — ninguna organización
  // publica esto como serie FRED separada lista para usar, carga manual.
  {
    id: 'gdp_domestic_demand',
    ...
    goodDirection: 'up',
    description: 'Contribución de la demanda interna (consumo + inversión + gasto público) al crecimiento del PIB. Subcomponente de PIB Trimestral. Carga manual.',
    parentId: 'gdp_qoq',
  },
  {
    id: 'gdp_external_demand',
    ...
    sourceUrl: 'https://www.bea.gov/data/gdp/gross-domestic-product',
    goodDirection: 'up',
    description: 'Contribución del comercio neto (exportaciones menos importaciones) al crecimiento del PIB. Subcomponente de PIB Trimestral. Carga manual.',
    parentId: 'gdp_qoq',
  },
  {
    id: 'retail_sales',
