...
const USD_INDICATORS: IndicatorMeta[] = [
  ...
  // negocios (el equivalente a "producción" en servicios), empleo, precios.
  {
    id: 'sp_pmi_serv_new_orders',
    label: 'S&P Global PMI Servicios — Nuevas Órdenes',
    ...
    sourceUrl: 'https://www.pmi.spglobal.com/Public/Home/PressRelease',
    goodDirection: 'up',
    description: 'Subcomponente del S&P Global PMI Servicios. Carga manual.',
    parentId: 'sp_pmi_serv',
  },
  {
    id: 'sp_pmi_serv_business_activity',
    label: 'S&P Global PMI Servicios — Actividad de Negocios',
  ...
  {
    id: 'sp_pmi_serv_employment',
    label: 'S&P Global PMI Servicios — Empleo',
    shortLabel: 'Empleo',
    section: 'crecimiento',
    format: 'index',
    frequency: 'monthly',
  ...
  {
    id: 'sp_pmi_serv_prices',
    label: 'S&P Global PMI Servicios — Precios',
    shortLabel: 'Precios',
    section: 'crecimiento',
    format: 'index',
    frequency: 'monthly',
  ...
  },
  {
    ...
    sourceUrl: 'https://www.bls.gov/ces/',
    goodDirection: 'up',
    description: 'Variación mensual del salario medio por hora (Average Hourly Earnings), serie ajustada estacionalmente.',
  },
  {
    id: 'wage_pct_yoy',
    label: 'Ganancias Promedio por Hora (a/a)',
    shortLabel: 'AHE a/a',
    section: 'empleo',
    format: 'pct1',
    frequency: 'monthly',
    ...
    sourceUrl: 'https://www.bls.gov/ces/',
    goodDirection: 'up',
    description: 'Variación interanual del salario medio por hora (Average Hourly Earnings) — la medida de presión salarial que sigue la Fed.',
  },
  {
    id: 'eci_qoq',
    label: 'Índice de Costo Laboral (t/t)',
    shortLabel: 'ECI t/t',
    section: 'empleo',
    format: 'pct1',
    frequency: 'quarterly',
    chart: 'bar',
    source: 'Bureau of Labor Statistics (FRED: ECIALLCIV)',
    sourceUrl: 'https://fred.stlouisfed.org/series/ECIALLCIV',
    goodDirection: 'up',
    description:
      'Compensación total (salarios + beneficios) de trabajadores civiles, variación trimestral ajustada estacionalmente — a diferencia de AHE, no se ve afectado por cambios en la composición del empleo (mix de industrias/ocupaciones). Es la medida de costo laboral que más de cerca sigue la Fed.',
  },
  {
    id: 'eci_yoy',
    label: 'Índice de Costo Laboral (a/a)',
    shortLabel: 'ECI a/a',
    section: 'empleo',
    format: 'pct1',
    frequency: 'quarterly',
    chart: 'line',
    source: 'Bureau of Labor Statistics (FRED: CIU1010000000000I)',
    sourceUrl: 'https://fred.stlouisfed.org/series/CIU1010000000000I',
    goodDirection: 'up',
    description: 'Variación interanual del Índice de Costo Laboral (compensación total, trabajadores civiles), serie sin ajustar estacionalmente — misma convención que el a/a de CPI/PPI.',
  },
  {
    id: 'jolts',
  ...
  // Subcomponentes del PIB por el lado del gasto (a pedido del usuario,
  // reemplaza la vieja Demanda Interna/Externa por el desglose clásico
  // C+I+G+NX) — BEA publica esto directo como "contribución al % de
  ...
  },
  {
    ...
    frequency: 'quarterly',
    chart: 'bar',
    source: 'Bureau of Economic Analysis (FRED: A006RY2Q224SBEA)',
    sourceUrl: 'https://fred.stlouisfed.org/series/A006RY2Q224SBEA',
    goodDirection: 'up',
    description: 'Contribución de la inversión privada bruta (fija + inventarios) al crecimiento del PIB, en puntos porcentuales.',
    parentId: 'gdp_qoq',
  },
  {
    id: 'gdp_government',
    ...
    frequency: 'quarterly',
    chart: 'bar',
    source: 'Bureau of Economic Analysis (FRED: A822RY2Q224SBEA)',
    sourceUrl: 'https://fred.stlouisfed.org/series/A822RY2Q224SBEA',
    goodDirection: 'up',
    description: 'Contribución del gasto público (consumo + inversión de gobierno) al crecimiento del PIB, en puntos porcentuales.',
    parentId: 'gdp_qoq',
  },
  {
    id: 'gdp_net_exports',
    ...
    frequency: 'quarterly',
    chart: 'bar',
    source: 'Bureau of Economic Analysis (FRED: A019RY2Q224SBEA)',
    sourceUrl: 'https://fred.stlouisfed.org/series/A019RY2Q224SBEA',
    goodDirection: 'up',
    description: 'Contribución de las exportaciones netas (exportaciones menos importaciones) al crecimiento del PIB, en puntos porcentuales.',
    parentId: 'gdp_qoq',
  },
  {
    id: 'retail_sales',
