...
export const GBP_INDICATORS: IndicatorMeta[] = [
  ...
  {
    id: 'gbp_pmi_manuf_flash_new_orders',
  ...
  },
  {
    ...
    sourceUrl: 'https://www.ons.gov.uk/economy/grossdomesticproductgdp/bulletins/gdpmonthlyestimateuk/latest',
    goodDirection: 'neutral',
    description: 'Medida de inflación implícita en el PIB del Reino Unido. Subcomponente de PIB Mensual. Carga manual.',
    parentId: 'gbp_gdp_mom',
  },
  {
    id: 'gbp_gdp_consumption',
    label: 'PIB — Consumo',
    shortLabel: 'Consumo',
    section: 'crecimiento',
    format: 'pct1',
    ...
    sourceUrl: 'https://www.ons.gov.uk/economy/grossdomesticproductgdp/bulletins/gdpmonthlyestimateuk/latest',
    goodDirection: 'up',
    description: 'Contribución del consumo privado al crecimiento del PIB de el Reino Unido. Carga manual.',
    parentId: 'gbp_gdp_mom',
  },
  {
    id: 'gbp_gdp_investment',
    label: 'PIB — Inversión',
    ...
    sourceUrl: 'https://www.ons.gov.uk/economy/grossdomesticproductgdp/bulletins/gdpmonthlyestimateuk/latest',
    goodDirection: 'up',
    description: 'Contribución de la inversión (formación bruta de capital) al crecimiento del PIB de el Reino Unido. Carga manual.',
    parentId: 'gbp_gdp_mom',
  },
  {
    id: 'gbp_gdp_government',
    ...
    sourceUrl: 'https://www.ons.gov.uk/economy/grossdomesticproductgdp/bulletins/gdpmonthlyestimateuk/latest',
    goodDirection: 'up',
    description: 'Contribución del gasto público al crecimiento del PIB de el Reino Unido. Carga manual.',
    parentId: 'gbp_gdp_mom',
  },
  {
    id: 'gbp_gdp_net_exports',
    ...
    sourceUrl: 'https://www.ons.gov.uk/economy/grossdomesticproductgdp/bulletins/gdpmonthlyestimateuk/latest',
    goodDirection: 'up',
    description: 'Contribución de las exportaciones netas (exportaciones menos importaciones) al crecimiento del PIB de el Reino Unido. Carga manual.',
    parentId: 'gbp_gdp_mom',
  },
  {
