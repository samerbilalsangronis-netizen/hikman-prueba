...
export const GBP_INDICATORS: IndicatorMeta[] = [
  ...
  },
  {
    ...
    sourceUrl: 'https://www.ons.gov.uk/economy/grossdomesticproductgdp/bulletins/gdpmonthlyestimateuk/latest',
    goodDirection: 'up',
    description: 'Contribución de la demanda interna al crecimiento del PIB del Reino Unido. Carga manual.',
    parentId: 'gbp_gdp_mom',
  },
  {
    id: 'gbp_gdp_external_demand',
    ...
    sourceUrl: 'https://www.ons.gov.uk/economy/grossdomesticproductgdp/bulletins/gdpmonthlyestimateuk/latest',
    goodDirection: 'up',
    description: 'Contribución del comercio neto al crecimiento del PIB del Reino Unido. Carga manual.',
    parentId: 'gbp_gdp_mom',
  },
  {
