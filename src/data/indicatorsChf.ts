...
export const CHF_INDICATORS: IndicatorMeta[] = [
  ...
  // divisas): precios, producción, nuevas órdenes, empleo.
  {
    ...
    sourceUrl: 'https://www.procure.ch/de/leistungen/pmi.html',
    goodDirection: 'up',
    description: 'Subcomponente del PMI Manufactura de Suiza. Carga manual.',
    parentId: 'chf_pmi_manuf',
  },
  {
    id: 'chf_pmi_manuf_production',
  ...
  },
  {
    ...
    sourceUrl: 'https://www.procure.ch/de/leistungen/pmi.html',
    goodDirection: 'neutral',
    description: 'Subcomponente del PMI Manufactura de Suiza. Presión de precios en insumos. Carga manual.',
    parentId: 'chf_pmi_manuf',
  },
  {
    id: 'chf_pmi_serv',
  ...
  },
  {
    ...
    sourceUrl: 'https://www.procure.ch/de/leistungen/pmi.html',
    goodDirection: 'up',
    description: 'Subcomponente del PMI Servicios de Suiza. Carga manual.',
    parentId: 'chf_pmi_serv',
  },
  {
    id: 'chf_pmi_serv_business_activity',
  ...
  },
  {
    ...
    sourceUrl: 'https://www.procure.ch/de/leistungen/pmi.html',
    goodDirection: 'neutral',
    description: 'Subcomponente del PMI Servicios de Suiza. Presión de precios en insumos. Carga manual.',
    parentId: 'chf_pmi_serv',
  },
  {
    id: 'chf_retail_sales',
  ...
  },
  {
    ...
    sourceUrl: 'https://www.seco.admin.ch/en/gross-domestic-product',
    goodDirection: 'up',
    description: 'Contribución de la demanda interna al crecimiento del PIB de Suiza. Carga manual.',
    parentId: 'chf_gdp_qoq',
  },
  {
    id: 'chf_gdp_external_demand',
    ...
    sourceUrl: 'https://www.seco.admin.ch/en/gross-domestic-product',
    goodDirection: 'up',
    description: 'Contribución del comercio neto al crecimiento del PIB de Suiza. Carga manual.',
    parentId: 'chf_gdp_qoq',
  },
  {
    id: 'chf_gdp_yoy',
