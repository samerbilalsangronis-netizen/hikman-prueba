...
export const EUR_SCORE_SEED: ScoreRow[] = [
  ...
  { id: 'eur_cpi', label: 'CPI', valoracion: 0, weight: 'Máx(2) / Mín(-2)', currency: 'EUR' },
  { id: 'eur_core_cpi', label: 'Core CPI', valoracion: 0, weight: 'Informativo', currency: 'EUR' },
  { id: 'eur_cpi_yoy', label: 'CPI a/a', valoracion: 0, weight: 'Informativo', currency: 'EUR' },
  { id: 'eur_core_cpi_yoy', label: 'Core CPI a/a', valoracion: 0, weight: 'Informativo', currency: 'EUR' },
