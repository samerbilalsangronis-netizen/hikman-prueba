...
export const CNY_INDICATORS: IndicatorMeta[] = [
  ...
  },
  {
    ...
    sourceUrl: 'https://www.stats.gov.cn/english/PressRelease/',
    goodDirection: 'up',
    description: 'Contribución de la demanda interna al crecimiento del PIB de China. Carga manual.',
    parentId: 'cny_gdp_qoq',
  },
  {
    id: 'cny_gdp_external_demand',
    ...
    sourceUrl: 'https://www.stats.gov.cn/english/PressRelease/',
    goodDirection: 'up',
    description: 'Contribución del comercio neto al crecimiento del PIB de China. Carga manual.',
    parentId: 'cny_gdp_qoq',
  },
  {
    id: 'cny_gdp_yoy',
