...
export const AUD_INDICATORS: IndicatorMeta[] = [
  ...
  },
  {
    ...
    sourceUrl: 'https://www.abs.gov.au/statistics/economy/national-accounts/australian-national-accounts-national-income-expenditure-and-product/latest-release',
    goodDirection: 'up',
    description: 'Contribución de la demanda interna al crecimiento del PIB de Australia. Carga manual.',
    parentId: 'aud_gdp_qoq',
  },
  {
    id: 'aud_gdp_external_demand',
    ...
    sourceUrl: 'https://www.abs.gov.au/statistics/economy/national-accounts/australian-national-accounts-national-income-expenditure-and-product/latest-release',
    goodDirection: 'up',
    description: 'Contribución del comercio neto al crecimiento del PIB de Australia. Carga manual.',
    parentId: 'aud_gdp_qoq',
  },
  {
    id: 'aud_gdp_yoy',
