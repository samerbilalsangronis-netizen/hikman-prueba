...
export const NZD_INDICATORS: IndicatorMeta[] = [
  ...
  },
  {
    ...
    sourceUrl: 'https://www.stats.govt.nz/topics/gross-domestic-product/',
    goodDirection: 'up',
    description: 'Contribución de la demanda interna al crecimiento del PIB de Nueva Zelanda. Carga manual.',
    parentId: 'nzd_gdp_qoq',
  },
  {
    id: 'nzd_gdp_external_demand',
    ...
    sourceUrl: 'https://www.stats.govt.nz/topics/gross-domestic-product/',
    goodDirection: 'up',
    description: 'Contribución del comercio neto al crecimiento del PIB de Nueva Zelanda. Carga manual.',
    parentId: 'nzd_gdp_qoq',
  },
  {
    id: 'nzd_gdp_yoy',
